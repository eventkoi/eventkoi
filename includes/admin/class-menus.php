...
class Menus {
	...
	public static function init() {
		...
		add_action( 'admin_menu', array( __CLASS__, 'menu_order_fix' ), 999 );
		add_action( 'admin_menu_editor-menu_replaced', array( __CLASS__, 'menu_order_fix' ), 999 );

		add_action( 'admin_head', array( __CLASS__, 'add_menu_css' ) );
	}
